    ...
    include-in-header:
      text: |
        ...
        document.addEventListener("DOMContentLoaded", function() {
          document.body.setAttribute("data-page", "reception");
        });
        </script>
...
<p align="center" style="margin-top: -50px; margin-bottom: 2px;">
Click on a photo to view the animation.
</p>
<p align="center">
It may take up to 10 seconds to load.
</p>
<p align="center" style="margin-bottom: 25px;">
사진을 클릭하시면 애니메이션이 약 10초 후에 재생될 수 있습니다.
</p>
