...
specific_directory <- "/Users/bchoe/Downloads/quarto-gallery-main/photos/Highlights" # Replace with your actual directory path
file_names_in_dir <- list.files(specific_directory)
library(tidyverse)
fn <- str_c("![](photos/Highlights/", file_names_in_dir, '){.lightbox style="column-span: all;" group="ushuaia-gallery"}')
